...
export class IotDeviceDefenderCustomResource implements CustomResource {
    ...
    public async create(customResourceEvent: CustomResourceEvent) : Promise<any> {
        ...
        let auditEnabled: boolean = auditCheckEnabled === 'true';
        let auditCheckConfigurations: AuditCheckConfigurations = {
            "DEVICE_CERTIFICATE_EXPIRING_CHECK": {
                enabled: auditEnabled
            }
        }
        let targetEnabledBoolean: boolean = targetEnabled === 'true';
        let auditNotificationTargetConfigurations:Iot.AuditNotificationTargetConfigurations = {
            SNS: {
                targetArn: targetArn,
        ...
        let resourceExists:boolean = false;
        try {
