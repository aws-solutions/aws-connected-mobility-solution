export class LambdaApiGatewayEventBuilder implements LambdaApiGatewayEvent {
    ...
    public queryStringParameters: QueryStringParametersDictionary;
    ...
    public setQueryStringParameters(value: QueryStringParametersDictionary) {
...
export interface LambdaApiGatewayEvent {
    ...
    queryStringParameters: QueryStringParametersDictionary | null;
...
export class  QueryStringParametersDictionary {
